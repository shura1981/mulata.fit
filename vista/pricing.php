					...
					<div class="container">						
						<div class="row justify-content-center">
							<div class="col-sm-9 col-md-7 col-lg-4 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
								<span class="thumb-info custom-thumb-info-2">
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary custom-font-style-1">Yearly</h4>
										<span class="font-weight-bold text-color-primary custom-font-style-2">$199 / month</span>
							...
							<div class="col-sm-9 col-md-7 col-lg-4 custom-sm-margin-1 custom-xs-margin-2 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1000">
								<span class="thumb-info custom-thumb-info-2">
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary custom-font-style-1">Monthly</h4>
										<span class="font-weight-bold text-color-primary custom-font-style-2">$229 / month</span>
										<ul class="list custom-pricing-list list-primary list-borders">
											<li>Unlimited Use</li>
											<li>Yoga Classes</li>
											<li>Zumba Classes</li>
							...
							<div class="col-sm-9 col-md-7 col-lg-4 custom-sm-margin-1 custom-xs-margin-2 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="2000">
								<span class="thumb-info custom-thumb-info-2">
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary custom-font-style-1">Personal</h4>
										<span class="font-weight-bold text-color-primary custom-font-style-2">$399 / month</span>
										<ul class="list custom-pricing-list list-primary list-borders">
											<li>Unlimited Use</li>
											<li>Yoga Classes</li>
											<li>Zumba Classes</li>
