				...
				<section class="section section-quaternary section-center section-no-border m-0">
					<div class="container">
						<div class="row justify-content-center mb-4 mb-md-0 mb-lg-5">
							<div class="col-md-6 pb-3 col-lg-3">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-1.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Jessica Doe</h4>
							...
							<div class="col-md-6 pb-3 col-lg-3 custom-xs-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-2.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Barbara Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
							</div>
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-3.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Monica Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
							...
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-4.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Rachael Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
						...
						<div class="row justify-content-center">
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2 custom-xs-margin-1">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-5.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Angelina Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
							...
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-6.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Judy Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
							...
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-7.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">Bob Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
							...
							<div class="col-md-6 pb-3 col-lg-3 custom-sm-margin-2">
								<span class="thumb-info custom-thumb-info-2 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="<?php echo URL_VISTA?>img/demos/gym/staff/staff-8.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-light text-center p-5">
										<h4 class="font-weight-bold text-color-quaternary mb-3">John Doe</h4>
										<p class="text-color-dark p-0">Personal Trainer</p>
										<a class="btn btn-primary custom-btn-style-1 text-uppercase text-color-light custom-font-weight-medium" href="demo-gym-staff-detail.html" title="Learn More">View More</a>
									</span>
								</span>
